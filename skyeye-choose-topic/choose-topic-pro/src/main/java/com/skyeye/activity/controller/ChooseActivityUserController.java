 ...
 */
@RestController
@Api(value = "活动可参与的学生信息管理", tags = "活动可参与的学生信息管理", modelName = "活动可参与的学生信息管理")
public class ChooseActivityUserController {
     ...
     */
    @ApiOperation(id = "insertActivityUserList", value = "新增活动可参与的学生信息", method = "POST", allUse = "2")
     ...
     * @param outputObject 出参以及提示信息的返回值对象
     */
    @ApiOperation(id = "queryActivityUserList", value = "分页获取活动可参与学生的信息列表", method = "POST", allUse = "2")
    @ApiImplicitParams(classBean = CommonPageInfo.class,
            value = {
                    @ApiImplicitParam(id = "objectId", name = "objectId", value = "活动id"),
            })
    ...
    public void queryPageList(InputObject inputObject, OutputObject outputObject) {
        chooseActivityUserService.queryPageList(inputObject, outputObject);
    }
     ...
     * @param outputObject 出参以及提示信息的返回值对象
     */
    @ApiOperation(id = "deleteActivityUserById", value = "删除活动可参与学生的信息", method = "POST", allUse = "2")
    @ApiImplicitParams({
