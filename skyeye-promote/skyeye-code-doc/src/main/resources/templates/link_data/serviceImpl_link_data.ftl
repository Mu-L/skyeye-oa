...
public class ${tables[0].entityName}ServiceImpl extends SkyeyeLinkDataServiceImpl<${tables[0].entityName}Dao, ${tables[0].entityName}> implements ${tables[0].entityName}Service {
