...
@RestController
@Api(value = "借出出库申请", tags = "借出出库申请", modelName = "借出出库申请")
public class ProductLeadController {
     ...
     */
    @ApiOperation(id = "queryProductLeadList", value = "获取借出出库申请单信息列表", method = "POST", allUse = "2")
     ...
     * @param outputObject 出参以及提示信息的返回值对象
     */
    @ApiOperation(id = "writeProductLead", value = "新增/编辑借出出库申请单", method = "POST", allUse = "2")
