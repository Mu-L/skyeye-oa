...
/**
 * @ClassName: SupplierContractChild
 * @Description: 供应商合同-商品明细实体类
 ...
 */
@Data
@TableName(value = "erp_supplier_contract_child")
@ApiModel("供应商合同-商品明细实体类")
public class SupplierContractChild extends CommonInfo {
