...
/**
 * @ClassName: SupplierInvoiceHeaderController
 * @Description: 供应商发票抬头管理
 ...
 */
@RestController
@Api(value = "供应商发票抬头管理", tags = "供应商发票抬头管理", modelName = "供应商发票抬头管理")
public class SupplierInvoiceHeaderController {

    @Autowired
    private SupplierInvoiceHeaderService invoiceHeaderService;
    ...
    @RequestMapping("/post/SupplierInvoiceHeaderController/queryInvoiceHeaderList")
    ...
    @RequestMapping("/post/SupplierInvoiceHeaderController/deleteInvoiceHeaderById")
