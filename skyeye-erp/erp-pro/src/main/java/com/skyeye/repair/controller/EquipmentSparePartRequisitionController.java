...
public class EquipmentSparePartRequisitionController {
    ...
    @ApiOperation(id = "deleteEquipmentSparePartRequisitionById", value = "根据ID删除备件领用单", method = "DELETE", allUse = "1")
    @ApiImplicitParams(value = {
        @ApiImplicitParam(id = "id", name = "id", value = "主键id", required = "required")})
    ...
    @ApiOperation(id = "deleteEquipmentSparePartRequisitionByIds", value = "批量删除备件领用单", method = "DELETE", allUse = "1")
    @ApiImplicitParams(value = {
    ...
    @ApiOperation(id = "submitToApprovalEquipmentSparePartRequisition", value = "备件领用单提交审批", method = "POST", allUse = "1")
    ...
    @ApiOperation(id = "revokeEquipmentSparePartRequisition", value = "撤销备件领用单审批申请", method = "PUT", allUse = "1")
    @ApiImplicitParams({
