 ...
 */
@Service
@SkyeyeService(name = "维修工单备件领用明细", groupName = "设备维修", manageShow = false)
public class EquipmentSparePartRequisitionDetailServiceImpl extends SkyeyeLinkDataServiceImpl<EquipmentSparePartRequisitionDetailDao, EquipmentSparePartRequisitionDetail>
    ...
    @Override
    public void validateUserStock(String userId, List<EquipmentSparePartRequisitionDetail> detailList) {
