...
/**
 * @ClassName: DocMemberLoginLog
 * @Description: 文档会员登录日志实体类
 ...
 */
@Data
@TableName(value = "member_login_log", autoResultMap = true)
@ApiModel("文档会员登录日志实体类")
public class DocMemberLoginLog extends CommonInfo {
    ...
    @ApiModelProperty(value = "登录状态", enumClass = DocMemberLoginLogStatus.class, required = "required,num")
    ...
    @ApiModelProperty(value = "设备类型", enumClass = DocMemberLoginLogDeviceType.class)
