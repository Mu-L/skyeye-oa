...
import com.skyeye.rest.school.student.rest.ISchoolRest;
import com.skyeye.rest.school.student.service.ISchoolService;
...
public class ISchoolServiceImpl extends IServiceImpl implements ISchoolService {
    ...
    public List<Map<String, Object>> queryEntityMationByIds(String ids) {
        return ExecuteFeignClient.get(() -> iSchoolRest.querySchoolByIds(ids)).getRows();
    }

    @Override
    public String queryCacheKeyById(String id) {
        return String.format(Locale.ROOT, "%s:%s", CacheConstants.SC_SCHOOL_CACHE_KEY, id);
    }
}
