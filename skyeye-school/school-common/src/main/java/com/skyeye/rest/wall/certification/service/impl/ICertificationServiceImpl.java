...
/**
 * @ClassName: ICertificationServiceImpl
 * @Description: 学生认证信息
 ...
 */
@Service
public class ICertificationServiceImpl extends IServiceImpl implements ICertificationService {
    ...
    public Map<String, Object> queryCertificationById(String id) {
        return ExecuteFeignClient.get(() -> iCertificationRest.queryCertificationById(id)).getBean();
    }
