...
public class LessonReviewTypeController {
    ...
    @ApiOperation(id = "writeLessonReviewType", value = "新增/编辑听评课角色", method = "POST", allUse = "2")
    ...
    @ApiOperation(id = "queryLessonReviewTypeList", value = "获取听评课角色信息", method = "POST", allUse = "2")
    ...
    @ApiOperation(id = "queryLessonReviewTypeById", value = "根据id查询听评课角色信息", method = "GET", allUse = "2")
    @ApiImplicitParams({
    ...
    @ApiOperation(id = "deleteLessonReviewTypeById", value = "根据ID删除听评课角色信息", method = "DELETE", allUse = "2")
    @ApiImplicitParams({
        @ApiImplicitParam(id = "id", name = "id", value = "主键id", required = "required")})
