...
public class AssetPurchaseServiceImpl extends SkyeyeBusinessServiceImpl<AssetPurchaseDao, AssetPurchase> implements AssetPurchaseService {
    ...
    @Override
    public void writePostpose(AssetPurchase entity, String userId) {
