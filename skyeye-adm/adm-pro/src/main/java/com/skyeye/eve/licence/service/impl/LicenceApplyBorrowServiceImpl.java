...
public class LicenceApplyBorrowServiceImpl extends SkyeyeBusinessServiceImpl<LicenceUseDao, LicenceUse> implements LicenceApplyBorrowService {
    ...
    @Override
    public void writePostpose(LicenceUse entity, String userId) {
