...
/**
 * @ClassName: DwQuChenColumn
 * @Description: 矩陈题列选项实体类
...
@Data
@UniqueField
@TableName(value = "dw_qu_chen_column")
@ApiModel(value = "矩陈题列选项实体类")
public class DwQuChenColumn extends OperatorUserInfo {
