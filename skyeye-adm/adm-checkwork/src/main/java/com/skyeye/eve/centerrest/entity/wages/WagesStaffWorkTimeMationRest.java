...
package com.skyeye.eve.centerrest.entity.wages;
...
public class WagesStaffWorkTimeMationRest implements Serializable {

    @ApiModelProperty(value = "员工对应的考勤班次")
    private List<CheckWorkTime> staffWorkTime;
